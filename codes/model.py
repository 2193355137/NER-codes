...
class Model(object):
    def __init__(self, config):
        ...
        init_checkpoint = "%s/albert_base_zh_additional_36k_steps/albert_model.ckpt" % project_dir
        # 获取模型中所有的训练参数。
    ...
    def bert_embedding(self):
        ...
        bert_config = modeling.BertConfig.from_json_file(
            "%s/albert_base_zh_additional_36k_steps/albert_config_base.json" % project_dir)  # 配置文件地址
